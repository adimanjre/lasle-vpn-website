...
const footer = () => {
    return (
        <div className="py-10">
            <div className="subsribe-container -mt-36">
                <SubscribeCard />
            </div>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-20">
                    <div className="logo-social-container">
                        <div className="logo-container flex items-center gap-3">
                            <Image src={'/img/logo.png'} alt='logo-icon' width={40} height={40}/>
                            <p className='text-xl antialiased font-medium'>LaslesVPN</p>
                        </div>
                        <p className="text-base text-gray-700 font-medium mt-3"><b>LaslesVPN</b> is a private virtual network that has unique features and has high security.</p>
                        <div className="social-container flex items-center mt-5 gap-3">
                            <div className="facebook-icon bg-red-500 rounded-full">
                            ...
                            <div className="twitter-icon bg-red-500 rounded-full">
                            ...
                            <div className="instagram-icon bg-red-500 rounded-full">
                        ...
                        <p className="text-base text-stone-400 mt-3">©2020LaslesVPN</p>
                    </div>
                    <div className="link-container flex gap-10 md:gap-20 justify-between">
                        <div className="product-link">
                            <h1 className="text-lg text-base-800 font-semibold">Product</h1>
                            <div className="link-contaienr flex flex-col gap-3 mt-3">
                                <Link href="#" className="text-base font-normal text-gray-600" >Download </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Pricing </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Locations </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Server </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Countries </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Blog </Link>
                            </div>
                        </div>
                        <div className="engage-link">
                            <h1 className="text-lg text-base-800 font-semibold">Engage</h1>
                            <div className="link-contaienr flex flex-col gap-3 mt-3">
                                <Link href="#" className="text-base font-normal text-gray-600" >LaslesVPN ?  </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >FAQ </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Tutorials </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >About Us </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Privacy Policy </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Terms of Service </Link>
                            </div>
                        </div>
                        <div className="earnMoney-link">
                            <h1 className="text-lg text-base-800 font-semibold">Earn Money</h1>
                            <div className="link-contaienr flex flex-col gap-3 mt-3">
                                <Link href="#" className="text-base font-normal text-gray-600" >Affiliate </Link>
                                <Link href="#" className="text-base font-normal text-gray-600" >Become Partner </Link>
                            </div>
                        </div>
                    </div>
                </div>
